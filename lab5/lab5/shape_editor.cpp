...
{
    checkedChooseLine = !checkedChooseLine; 
...
{
    checkedChoosePoint = !checkedChoosePoint;
    if (CheckMenuItem(GetMenu(hwnd), checkItem, NULL) == MF_CHECKED)
    {
        CheckMenuItem(GetMenu(hwnd), checkItem, MF_UNCHECKED);
    }
...
{
    checkedChooseRectangle = !checkedChooseRectangle;
    if (CheckMenuItem(GetMenu(hwnd), checkItem, NULL) == MF_CHECKED)
    {
        CheckMenuItem(GetMenu(hwnd), checkItem, MF_UNCHECKED);
    }
...
{
    checkedChooseEllipse = !checkedChooseEllipse; 
    if (CheckMenuItem(GetMenu(hwnd), checkItem, NULL) == MF_CHECKED)
    {
        CheckMenuItem(GetMenu(hwnd), checkItem, MF_UNCHECKED);
    }
